...
export const POST: RequestHandler = async (event) => {
   ...
   const response = await fetch('https://api.demo.convergepay.com/hosted-payments/transaction_token', {
      ...
      body: JSON.stringify({
         ...
         ssl_first_name: customer.givenName,
         ssl_last_name: customer.familyName,
         ssl_company: customer.organizationName ? customer.organizationName : undefined,
         ssl_transacction_currency: 'USD'
      })
   })
