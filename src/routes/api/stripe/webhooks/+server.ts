...
import type { Invoice, Lease, PaymentRecord, User } from '../../../../generated/prisma/client';
import { paymentNote } from '$lib/utils/paymentNote';
                     ...
                     if(invoice){
                        const paymentRecord = await prisma.paymentRecord.create({
                           data: {
                              ...
                              paymentType: 'CREDIT',
                              paymentNotes: paymentNote(invoice.invoiceNum, invoice.invoiceNotes),
