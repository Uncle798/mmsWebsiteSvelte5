...
{#if data.user?.employee}
    {#if data.invoice}      
        ...
        <div class="flex flex-col sm:flex-row gap-x-1 mx-1 sm:mx-2 mt-12 sm:mt-10 border-2 border-primary-50-950 rounded-lg">
...
{:else}
    {#if data.invoice}
        <Header title="Invoice number {data.invoice.invoiceNum}" />
        <div class="flex flex-col sm:flex-row gap-x-1 mx-1 sm:mx-2 mt-12 sm:mt-10 mb-20 sm:mb-12 lg:mb-7 border-2 border-primary-50-950 rounded-lg w-fit">
