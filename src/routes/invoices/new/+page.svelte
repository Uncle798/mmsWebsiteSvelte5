...
{:else if data.customer}
   <NewInvoiceForm data={data.newInvoiceForm} employeeId={data.user?.id} customers={data.customer} leases={data.leases} defaultCustomer={data.customer[0].id} classes='mt-14 sm:mt-10 m-1 sm:m-2'/>
{/if}