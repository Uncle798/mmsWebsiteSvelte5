...
export const actions: Actions = {
	default: async (event) => {
		...
		return message(
			magicLinkForm,
			`An email from ${PUBLIC_COMPANY_EMAIL} has been sent to log you in, please check your spam folder as it may have ended up there. Feel free to close this tab.`
		);
	}
};
