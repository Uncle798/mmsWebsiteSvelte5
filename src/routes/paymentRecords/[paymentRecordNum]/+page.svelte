...
{#if data.paymentRecord }
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1 m-1 sm:m-2 mt-10 sm:mt-10 border-2 dark:border-primary-950 border-primary-50 rounded-lg w-fit">
