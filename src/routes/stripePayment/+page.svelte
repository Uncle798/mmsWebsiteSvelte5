...
{#if data.newLease}
{#if !mounted}
    <div in:fade={{duration:600}} class="mt-12 sm:mt-10 m-2">
        ...loading
    </div>
{:else}
    <div class="mt-12 sm:mt-10 mx-1 sm:mx-2" in:fade={{duration:600}}>
...
{:else}
    {#if !mounted}
        ...
        {:else}
        <div bind:this={wrapper} class="mt-12 sm:mt-10 m-2" in:fade={{duration:600}}></div>
    {/if}
{/if} -->